...
class DatabaseSettings(BaseModel):
    ...
    type: str = Field("postgresql", description="The type of database (e.g., postgresql, redshift).")
    host: str = "localhost"
    port: int = 5432
    user: str = "user"
...
class DownloaderSettings(BaseModel):
    ...
    download_dir: str = Field("./downloads", description="Directory to store downloaded FAERS files.")
